...
class CarControllerParams:
  def __init__(self, CP):
    if CP.carFingerprint in [CAR.KIA_STINGER, CAR.SONATA, CAR.PALISADE, CAR.SANTA_FE, CAR.VELOSTER, CAR.GENESIS_G70, CAR.IONIQ_EV_2020, CAR.KIA_CEED, CAR.KIA_SELTOS]:
      self.STEER_MAX = 384
    else:
      self.STEER_MAX = 255
